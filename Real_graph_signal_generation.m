% 7-nearest neighbor graph signal generation technique based on paper
...
coordinates_matrix = [longitudeVector latitudeVector];   % 197x2-matrix containing the points longitude and latitude values
...
save('Ext_Real_graph_and_sampling.mat','completeDatasetMatrix','completeDatasetMatrix2','A','D','D_s','F','M','U','U_f','used_indices');
